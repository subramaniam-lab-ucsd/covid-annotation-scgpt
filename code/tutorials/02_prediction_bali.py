...
trainingStudies = ["Wilk", "Lee", "SS_C1", "SS_C2"]
testStudies = ["Bali"]
...
adata_test_raw.write_h5ad(data_dir/"predictionsBali.h5ad")


# In[ ]:


torch.save(best_model.state_dict(), save_dir / "baliModel.pt")
