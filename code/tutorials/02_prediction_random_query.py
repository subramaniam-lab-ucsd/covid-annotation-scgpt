...
# # Fine-tuning on Pre-trained Model for Cell-type Annotation in COVID dataset RANDOM QUERY SET
# 
# 
...
hyperparameter_defaults = dict(
    ...
    dab_weight=0.0,
    lr=1e-4,
    batch_size=64, #rtx3090 - 18, a100 half node - 32, a100 full node - 64, v100 - 24
    layer_size=128,
...
adata_test_raw.write_h5ad(data_dir/"predictionsRandom.h5ad")


# In[ ]:


torch.save(best_model.state_dict(), save_dir / "randomModel.pt")
