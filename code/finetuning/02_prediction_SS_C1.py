...
trainingStudies = ["Wilk", "Bali", "Lee", "SS_C2"]
testStudies = ["SS_C1"]
...
adata_test_raw.write_h5ad(data_dir/"predictionsSS_C1.h5ad")


# In[ ]:


torch.save(best_model.state_dict(), save_dir / "SS_C1_Model.pt")
