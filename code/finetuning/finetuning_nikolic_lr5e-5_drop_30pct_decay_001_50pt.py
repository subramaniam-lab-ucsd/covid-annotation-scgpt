...
hyperparameter_defaults = dict(
    ...
    dab_weight=0.0,
    lr=5e-5,
    batch_size=24, #rtx3090 - 18, a100 - 32, v100 - 24, 2 a30s - 18, 3 a30s - 
    layer_size=128,
...
# %%
adata = sc.pp.subsample(adataOriginal, fraction=0.5, copy=True)
...
# %%
#  # clear GPU cache before finetuning task
...
# %%
adata_test_raw.write_h5ad(data_dir/"predictionsNikolic_10pc_60_ep_lr10-5_25pt.h5ad")

# %%
torch.save(best_model.state_dict(), save_dir / "nikolic_best_model_10pc_60_ep_lr10-5_25pt.pt")
